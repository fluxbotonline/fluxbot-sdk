...
var BotModeSchema = z.enum(["paper", "live"]);
var StartStopResponseSchema = z.object({ ok: z.boolean(), started: z.boolean().optional() });
...
var EventsResponseSchema = z.object({ ok: z.boolean().default(true), events: z.array(BotEventSchema) });
